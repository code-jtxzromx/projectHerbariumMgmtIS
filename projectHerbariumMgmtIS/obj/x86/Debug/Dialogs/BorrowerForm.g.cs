#pragma checksum "C:\Users\Jtxzromx Casingal\Documents\Visual Studio 2017\Projects\projectHerbariumMgmtIS\projectHerbariumMgmtIS\Dialogs\BorrowerForm.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "E038EDA44D579164475D86BB068C41AF"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IBorrowerForm_Bindings
        {
            ...
            private void Update_BorrowerData_BorrowerID(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 44
            ...
            private void Update_BorrowerData_FirstName(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 48
            ...
            private void Update_BorrowerData_MiddleName(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 51
            ...
            private void Update_BorrowerData_LastName(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 59
            ...
            private void Update_BorrowerData_MiddleInitial(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 62
            ...
            private void Update_BorrowerData_NameSuffix(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 65
            ...
            private void Update_BorrowerData_HomeAddress(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 71
            ...
            private void Update_BorrowerData_ContactNumber(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 77
            ...
            private void Update_BorrowerData_Email(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 80
            ...
            private void Update_BorrowerData_Affiliation(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\BorrowerForm.xaml line 88
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 5: // Dialogs\BorrowerForm.xaml line 51
                ...
                break;
            case 6: // Dialogs\BorrowerForm.xaml line 54
                {
                    this.msgFirstName = (global::Windows.UI.Xaml.Controls.TextBlock)(target);
                }
                break;
            case 7: // Dialogs\BorrowerForm.xaml line 56
                {
            ...
            case 10: // Dialogs\BorrowerForm.xaml line 65
                ...
                break;
            case 11: // Dialogs\BorrowerForm.xaml line 68
                {
            ...
            case 12: // Dialogs\BorrowerForm.xaml line 71
                ...
                break;
            case 13: // Dialogs\BorrowerForm.xaml line 74
                {
            ...
            case 15: // Dialogs\BorrowerForm.xaml line 80
                ...
                break;
            case 16: // Dialogs\BorrowerForm.xaml line 83
                {
                    this.msgContactNumber = (global::Windows.UI.Xaml.Controls.TextBlock)(target);
                }
                break;
            case 17: // Dialogs\BorrowerForm.xaml line 85
                {
            ...
            case 18: // Dialogs\BorrowerForm.xaml line 88
                ...
                break;
            case 19: // Dialogs\BorrowerForm.xaml line 91
                {
