#pragma checksum "C:\Users\Jtxzromx Casingal\Documents\Visual Studio 2017\Projects\projectHerbariumMgmtIS\projectHerbariumMgmtIS\Dialogs\AccountForm.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "0299040F4FD4714DA694053247E9B24C"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IAccountForm_Bindings
        {
            ...
            private void Update_(global::projectHerbariumMgmtIS.Dialogs.AccountForm obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_IsEditTrans(obj.IsEditTrans, phase);
                    }
                }
            }
            ...
            private void Update_AccountData_Username(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\AccountForm.xaml line 45
            ...
            private void Update_AccountData_Password(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Dialogs\AccountForm.xaml line 48
            ...
            private class AccountForm_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsEditTrans(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    AccountForm_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
                        ...
                        if (obj != null)
                        {
                            bindings.Update_IsEditTrans(obj.IsEditTrans, DATA_CHANGED);
                        }
                    }
                }
                private long tokenDPC_TransactionForm = 0;
                private long tokenDPC_AccountData = 0;
                private long tokenDPC_IsEditTrans = 0;
                public void UpdateChildListeners_(global::projectHerbariumMgmtIS.Dialogs.AccountForm obj)
                {
                    ...
                    if (bindings != null)
                    {
                        if (bindings.dataRoot != null)
                        {
                            ...
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::projectHerbariumMgmtIS.Dialogs.AccountForm.IsEditTransProperty, tokenDPC_IsEditTrans);
                        }
                        if (obj != null)
                        {
                            ...
                            tokenDPC_IsEditTrans = obj.RegisterPropertyChangedCallback(global::projectHerbariumMgmtIS.Dialogs.AccountForm.IsEditTransProperty, DependencyPropertyChanged_IsEditTrans);
                        }
                    }
                }
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 4: // Dialogs\AccountForm.xaml line 38
                ...
                break;
            case 5: // Dialogs\AccountForm.xaml line 42
                {
            ...
            case 7: // Dialogs\AccountForm.xaml line 48
                ...
                break;
            case 8: // Dialogs\AccountForm.xaml line 51
                {
                    this.msgUsername = (global::Windows.UI.Xaml.Controls.TextBlock)(target);
                }
                break;
            case 9: // Dialogs\AccountForm.xaml line 53
                {
