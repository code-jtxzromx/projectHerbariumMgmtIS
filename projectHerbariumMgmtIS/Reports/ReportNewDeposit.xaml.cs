...
namespace projectHerbariumMgmtIS.Reports
{
    ...
    public sealed partial class ReportNewDeposit : Page
    {
        ...
        private void btnLoad_Click(object sender, RoutedEventArgs e)
        {
            ...
            MonthEnd = endDate;
            dgrReportResult.ItemsSource = new PlantDeposit().GetNewDepositReport(startDate.ToString(), endDate.ToString());
            btnPrint.Visibility = Visibility.Visible;
        }

        private async void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            DocumentNewDeposit form = new DocumentNewDeposit(new PlantDeposit().GetNewDepositReport(MonthStart.ToString(), MonthEnd.ToString()))
            {
