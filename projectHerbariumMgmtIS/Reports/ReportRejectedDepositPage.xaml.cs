...
namespace projectHerbariumMgmtIS.Reports
{
    ...
    /// </summary>
    public sealed partial class ReportRejectedDepositPage : Page
    {
        ...
        public ReportRejectedDepositPage()
        {
        ...
        private void btnLoad_Click(object sender, RoutedEventArgs e)
        {
            ...
            MonthEnd = endDate;
            dgrReportResult.ItemsSource = new PlantDeposit().GetRejectedDepositReport(startDate.ToString(), endDate.ToString());
            btnPrint.Visibility = Visibility.Visible;
        }

        private async void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            DocumentRejectedDeposit form = new DocumentRejectedDeposit(new PlantDeposit().GetRejectedDepositReport(MonthStart.ToString(), MonthEnd.ToString()))
            {
            ...
            await printHelper.ShowPrintUIAsync("Herbarium Management IS - List of Rejected Deposits", printHelperOptions);
