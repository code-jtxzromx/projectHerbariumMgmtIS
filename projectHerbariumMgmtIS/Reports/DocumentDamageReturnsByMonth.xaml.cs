...
namespace projectHerbariumMgmtIS.Reports
{
    ...
    /// </summary>
    public sealed partial class DocumentDamageReturnsByMonth : Page
    {
        // Properties
        public string Month
        {
        ...
        public DocumentDamageReturnsByMonth()
        {
            this.InitializeComponent();
        }

        public DocumentDamageReturnsByMonth(List<HerbariumSheet> herbariumSheets)
        {
            this.InitializeComponent();
